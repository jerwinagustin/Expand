...
<head>
    ...
    <title>Sign Up | Expand Expense Tracker</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="login-container">
        <form class="login-box" action="<?= base_url('signup') ?>" method="post">
            <?= csrf_field() ?>

            <h2>Create new Account</h2>
            <p class="signup-text">Already have an account? <a href="<?= base_url('login') ?>">Login</a></p>
            ...
            <div class="mb-3">
                ...
                <?php if (session()->getFlashdata('errors')['confirm_password'] ?? false): ?>
                    <div class="text-danger small mt-1"><?= session()->getFlashdata('errors')['confirm_password'] ?></div>
                <?php endif; ?>
            </div>
